...
class DemoOrderNoPurchaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        InquiryItem::create(['inquiry_id' => $inquiry->id, 'style_ref' => self::STYLE_NO, 'product_type_id' => $productType->id, 'color_ref' => 'Black', 'qty' => 6000, 'target_price' => 3.10]);
        ...
        // --- BOM (documents what's needed, even though buyer supplies it) ---
