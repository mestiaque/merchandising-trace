...
class DefaultTnaTemplateSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['Fabric Status', 'bulk_fabric_pi', 'Bulk Fabric PI (Booking date)', 'date', -28, null, 'Fabric', true, false, 'material_booking', 'BOOKING_DATE'],
            ['Fabric Status', 'bulk_fabric_lc', 'Bulk Fabric LC', 'date', -25, null, 'Fabric', false, false, 'material_booking', 'LC_DATE'],
            ['Fabric Status', 'fabric_mill_country', 'Fabric Mill Country', 'text', -25, null, 'Fabric', false, false, 'none'],
            ['Fabric Status', 'bulk_fabric_xmill', 'Bulk Fabric X mill', 'date', -18, null, 'Fabric', false, false, 'material_booking', 'XMILL_DATE'],
            ['Fabric Status', 'bulk_fabric_consignment_1', 'Bulk Fabric 1st consignment', 'date', -15, null, 'Fabric', true, true, 'material_booking', 'CONSIGNMENT_1'],
            ['Fabric Status', 'bulk_fabric_consignment_2', 'Bulk Fabric 2nd consignment', 'date', -12, null, 'Fabric', false, false, 'material_booking', 'CONSIGNMENT_2'],
            ['Fabric Status', 'bulk_fabric_consignment_3', 'Bulk Fabric 3rd consignment', 'date', -9, null, 'Fabric', false, false, 'material_booking', 'CONSIGNMENT_3'],
            ['Fabric Status', 'bulk_fabric_consignment_4', 'Bulk Fabric 4th consignment', 'date', -6, null, 'Fabric', false, false, 'material_booking', 'CONSIGNMENT_4'],
            ['Fabric Status', 'fabric_remarks', 'Remarks', 'text', 0, null, 'Fabric', false, false, 'none'],

            ['Sewing trims Status', 'thread', 'Thread', 'date', -10, null, 'Trims', true, true, 'material_booking', 'THREAD'],
            ['Sewing trims Status', 'zipper', 'Zipper', 'date', -10, null, 'Trims', true, true, 'material_booking', 'ZIPPER'],
            ['Sewing trims Status', 'main_label', 'Main Label', 'date', -10, null, 'Trims', true, true, 'material_booking', 'MAIN_LABEL'],
            ['Sewing trims Status', 'size_label', 'Size Label', 'date', -10, null, 'Trims', true, true, 'material_booking', 'SIZE_LABEL'],
            ['Sewing trims Status', 'care_label', 'Care Label', 'date', -10, null, 'Trims', true, true, 'material_booking', 'CARE_LABEL'],
            ['Sewing trims Status', 'elastics', 'Elastics', 'date', -10, null, 'Trims', true, true, 'material_booking', 'ELASTICS'],
            ['Sewing trims Status', 'buttons_sewing', 'Buttons', 'date', -10, null, 'Trims', true, true, 'material_booking', 'BUTTONS'],
            ['Sewing trims Status', 'velcro', 'Velcro', 'date', -10, null, 'Trims', true, true, 'material_booking', 'VELCRO'],
            ['Sewing trims Status', 'sewing_trims_remarks', 'Remarks', 'text', 0, null, 'Trims', false, false, 'none'],

            ['Finishing Trims', 'price_tag', 'Price tag', 'date', -5, null, 'Trims', false, false, 'material_booking', 'PRICE_TAG'],
            ['Finishing Trims', 'price_stickers', 'Price Stickers', 'date', -5, null, 'Trims', false, false, 'material_booking', 'PRICE_STICKER'],
            ['Finishing Trims', 'buttons_finishing', 'Buttons', 'date', -5, null, 'Trims', false, false, 'material_booking', 'BUTTONS'],
            ['Finishing Trims', 'cords', 'Cords', 'date', -5, null, 'Trims', false, false, 'material_booking', 'CORDS'],
            ['Finishing Trims', 'poly_bags', 'Poly Bags', 'date', -5, null, 'Trims', false, false, 'material_booking', 'POLY_BAG'],
            ['Finishing Trims', 'others_finishing', 'Others', 'date', -5, null, 'Trims', false, false, 'material_booking', 'OTHERS'],
            ['Finishing Trims', 'cartons', 'Cartons', 'date', -5, null, 'Trims', false, false, 'material_booking', 'CARTON'],
        ];
