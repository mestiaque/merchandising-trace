...
<div class="row">
    <div class="col-md-3 mb-3">
        ...
        <input type="date" name="inquiry_given_date" class="form-control form-control-sm" value="{{ old('inquiry_given_date', optional($inquiry->inquiry_given_date ?? null)->format('Y-m-d')) }}" required>
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="date" name="order_confirmation_due_date" class="form-control form-control-sm" value="{{ old('order_confirmation_due_date', optional($inquiry->order_confirmation_due_date ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="status" class="form-control form-control-sm" id="inquiryStatus">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="style_ref" class="form-control form-control-sm" maxlength="150" value="{{ old('style_ref', $inquiry->style_ref ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Color</label>
        <input type="text" name="color_ref" class="form-control form-control-sm" maxlength="150" value="{{ old('color_ref', $inquiry->color_ref ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Order Qty</label>
        <input type="number" min="0" name="target_qty" id="inqOrderQty" class="form-control form-control-sm" value="{{ old('target_qty', $inquiry->target_qty ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Unit Price</label>
        <input type="number" step="0.0001" min="0" name="target_price" id="inqUnitPrice" class="form-control form-control-sm" value="{{ old('target_price', $inquiry->target_price ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Total Value</label>
        <input type="text" id="inqTotalValue" class="form-control form-control-sm bg-light" readonly tabindex="-1">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Ship Date</label>
        <input type="date" name="target_ship_date" class="form-control form-control-sm" value="{{ old('target_ship_date', optional($inquiry->target_ship_date ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Extended Ship Date</label>
        <input type="date" name="extended_ship_date" class="form-control form-control-sm" value="{{ old('extended_ship_date', optional($inquiry->extended_ship_date ?? null)->format('Y-m-d')) }}">
        <span class="form-text">Only if the buyer extended the original ship date.</span>
    </div>
    <div class="col-md-3 mb-3" id="lostReasonField" style="{{ old('status', $inquiry->status ?? 'open') === 'lost' ? '' : 'display:none;' }}">
        <label class="form-label">Lost Reason</label>
        <input type="text" name="lost_reason" class="form-control form-control-sm" value="{{ old('lost_reason', $inquiry->lost_reason ?? '') }}">
    </div>
    <div class="col-12 mb-3">
        <label class="form-label">Description</label>
        <textarea name="description" class="form-control form-control-sm" rows="2">{{ old('description', $inquiry->description ?? '') }}</textarea>
    </div>
    <div class="col-12 mb-3">
        <label class="form-label">Remarks</label>
        <textarea name="remarks" class="form-control form-control-sm" rows="2">{{ old('remarks', $inquiry->remarks ?? '') }}</textarea>
    </div>
</div>
