...
<div class="form-check form-switch">
    ...
    <input type="checkbox" name="is_active" value="1" class="form-check-input" id="productTypeActive" @checked(old('is_active', $productType->is_active ?? true))>
    <label class="form-check-label" for="productTypeActive">Active</label>
</div>
