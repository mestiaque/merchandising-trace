...
<div class="mb-3">
    ...
    <input type="text" name="region" class="form-control" value="{{ old('region', $buyer->region ?? '') }}">
</div>
<div class="mb-3">
    <label class="form-label">Agent Name</label>
    <input type="text" name="agent_name" class="form-control" value="{{ old('agent_name', $buyer->agent_name ?? '') }}">
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" name="payment_term" class="form-control" value="{{ old('payment_term', $buyer->payment_term ?? '') }}">
</div>
<div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="number" step="0.01" name="default_aql" class="form-control" value="{{ old('default_aql', $buyer->default_aql ?? '') }}">
</div>
