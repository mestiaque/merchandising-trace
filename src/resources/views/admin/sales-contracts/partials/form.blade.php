...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="inquiry_id" class="form-control form-control-sm merch-select2">
            <option value="">— Select —</option>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="buyer_order_ref" class="form-control form-control-sm" value="{{ old('buyer_order_ref', $salesContract->buyer_order_ref ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Contract Date <span class="text-danger">*</span></label>
        <input type="date" name="contract_date" class="form-control form-control-sm" value="{{ old('contract_date', optional($salesContract->contract_date ?? null)->format('Y-m-d') ?? now()->toDateString()) }}" required>
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" step="0.0001" min="0" name="exchange_rate" class="form-control form-control-sm" value="{{ old('exchange_rate', $salesContract->exchange_rate ?? 1) }}">
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="payment_term" class="form-control form-control-sm" value="{{ old('payment_term', $salesContract->payment_term ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">LC No</label>
        <input type="text" name="lc_no" class="form-control form-control-sm" value="{{ old('lc_no', $salesContract->lc_no ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">LC Date</label>
        <input type="date" name="lc_date" class="form-control form-control-sm" value="{{ old('lc_date', optional($salesContract->lc_date ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">LC Value</label>
        <input type="number" step="0.0001" min="0" name="lc_value" class="form-control form-control-sm" value="{{ old('lc_value', $salesContract->lc_value ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">LC Expiry</label>
        <input type="date" name="lc_expiry" class="form-control form-control-sm" value="{{ old('lc_expiry', optional($salesContract->lc_expiry ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-12 mb-3">
        <label class="form-label">Remarks</label>
        <textarea name="remarks" class="form-control form-control-sm" rows="2">{{ old('remarks', $salesContract->remarks ?? '') }}</textarea>
    </div>
    <div class="col-12 mb-3">
