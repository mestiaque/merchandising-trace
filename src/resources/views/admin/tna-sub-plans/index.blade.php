...
<div class="flex-grow-1 merch-module">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="mb-0">Sub-T&amp;A (Embroidery / Print / After-Wash)</h4>
            @can('merch_tna.add')
                ...
                <tbody>
                    @forelse($subPlans as $sp)
                        <tr>
                            ...
                            <td><span class="badge badge-secondary">{{ ucfirst($sp->status) }}</span></td>
                            <td class="text-right"><a href="{{ route('merchandising-trace.tna-sub-plans.show', $sp) }}" class="btn-custom success"><i class="fa-solid fa-eye"></i></a></td>
                        </tr>
                    @empty
