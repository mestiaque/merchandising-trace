...
<div class="flex-grow-1 merch-module">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Add Sub-T&amp;A Plan (Embroidery / Print / After-Wash)</h5>
            ...
            <form method="POST" action="{{ route('merchandising-trace.tna-sub-plans.store') }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="sales_contract_po_id" class="form-control merch-select2" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="emb_print_type" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Required PSD</label>
                        <input type="date" name="required_psd" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Required PFD</label>
                        <input type="date" name="required_pfd" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                        <label class="form-label">Required Qty/Day</label>
                        <input type="number" min="0" name="required_qty_per_day" class="form-control">
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="vendor_id" class="form-control merch-select2">
                            <option value="">— Select —</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" min="0" name="po_qty" class="form-control" required>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary">Save</button>
                <a href="{{ route('merchandising-trace.tna-sub-plans.index') }}" class="btn btn-light">Cancel</a>
            </form>
        </div>
    </div>
</div>
