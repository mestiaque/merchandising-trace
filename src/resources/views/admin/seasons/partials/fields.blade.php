...
<div class="form-check form-switch">
    ...
    <input type="checkbox" name="is_active" value="1" class="form-check-input" id="seasonActive" @checked(old('is_active', $season->is_active ?? true))>
    <label class="form-check-label" for="seasonActive">Active</label>
</div>
