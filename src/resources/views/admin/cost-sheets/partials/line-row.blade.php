...
<tr>
    ...
    <td><input type="text" name="items[{{ $index }}][description]" class="form-control" maxlength="255" value="{{ $line['description'] ?? '' }}"></td>
    <td><input type="text" name="items[{{ $index }}][supplier_name]" class="form-control" maxlength="150" list="csSupplierList" value="{{ $line['supplier_name'] ?? '' }}"></td>
