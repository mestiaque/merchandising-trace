...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input type="text" name="collection_name" class="form-control" value="{{ old('collection_name', $riskAssessment->collection_name ?? '') }}">
    </div>
</div>
<div class="mb-3">
    <label class="form-label">Category</label>
    <input type="text" name="category" class="form-control" value="{{ old('category', $riskAssessment->category ?? '') }}">
</div>
<div class="row">
    <div class="col-md-6 mb-3">
        <label class="form-label">Sewing Factory</label>
        <select name="sewing_factory_id" class="form-control merch-select2">
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="print_factory_id" class="form-control merch-select2">
            <option value="">— N/A —</option>
            @foreach($factoriesOptions as $f)
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="embroidery_factory_id" class="form-control merch-select2">
            <option value="">— N/A —</option>
            @foreach($factoriesOptions as $f)
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="wash_factory_id" class="form-control merch-select2">
            <option value="">— N/A —</option>
            @foreach($factoriesOptions as $f)
...
<div class="mb-3">
    ...
    <textarea name="design_risk" class="form-control" rows="2">{{ old('design_risk', $riskAssessment->design_risk ?? '') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">Materials Risk Findings</label>
    <textarea name="materials_risk" class="form-control" rows="2">{{ old('materials_risk', $riskAssessment->materials_risk ?? '') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">Components Risk Findings</label>
    <textarea name="components_risk" class="form-control" rows="2">{{ old('components_risk', $riskAssessment->components_risk ?? '') }}</textarea>
</div>
<div class="mb-3">
    <label class="form-label">Production/Process Risk Findings</label>
    <textarea name="process_risk" class="form-control" rows="3">{{ old('process_risk', $riskAssessment->process_risk ?? '') }}</textarea>
</div>
<div class="form-check form-switch">
    <input type="hidden" name="is_active" value="0">
    <input type="checkbox" name="is_active" value="1" class="form-check-input" id="riskAssessmentActive{{ $riskAssessment->id ?? 'new' }}" @checked(old('is_active', $riskAssessment->is_active ?? true))>
    <label class="form-check-label" for="riskAssessmentActive{{ $riskAssessment->id ?? 'new' }}">Active</label>
</div>
