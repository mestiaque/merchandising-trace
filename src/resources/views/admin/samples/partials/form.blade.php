{{-- props: sample (optional, for edit), buyersOptions, stylesOptions, sizesOptions, sampleTypesOptions, seasonsOptions, merchandisersOptions --}}
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <label class="form-label">Size Ref (free text)</label>
