...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="sample_type_id" class="form-control form-control-sm merch-select2" required>
            <option value="">— Select —</option>
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="number" min="1" name="qty" class="form-control form-control-sm" value="{{ old('qty', $sample->qty ?? 1) }}" required>
    </div>
    <div class="col-md-3 mb-3">
    ...
    <div class="col-md-3 mb-3">
        ...
        <input type="text" name="size_ref" class="form-control form-control-sm" value="{{ old('size_ref', $sample->size_ref ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Color Ref</label>
        <input type="text" name="color_ref" class="form-control form-control-sm" value="{{ old('color_ref', $sample->color_ref ?? '') }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Request Date</label>
        <input type="date" name="request_date" class="form-control form-control-sm" value="{{ old('request_date', optional($sample->request_date ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-md-3 mb-3">
        <label class="form-label">Required Date</label>
        <input type="date" name="required_date" class="form-control form-control-sm" value="{{ old('required_date', optional($sample->required_date ?? null)->format('Y-m-d')) }}">
    </div>
    <div class="col-12 mb-3">
        <label class="form-label">Remarks</label>
        <textarea name="remarks" class="form-control form-control-sm" rows="2">{{ old('remarks', $sample->remarks ?? '') }}</textarea>
    </div>
</div>
