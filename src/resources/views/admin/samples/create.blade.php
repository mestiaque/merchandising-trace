...
@section('title')
    <title>{{ websiteTitle('Add Sample') }}</title>
@endsection
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('merchandising-trace.samples.store') }}">
                ...
                <a href="{{ route('merchandising-trace.samples.index') }}" class="btn btn-light mt-3 btn-sm">Cancel</a>
            </form>
        </div>
    </div>
</div>
