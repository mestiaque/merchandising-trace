...
<tr>
    <td>
        <select name="items[{{ $index }}][item_id]" class="form-control form-control-sm merch-select2" required>
    ...
    <td>
        <select name="items[{{ $index }}][color_id]" class="form-control form-control-sm merch-select2">
            <option value="">—</option>
    ...
    <td>
        <select name="items[{{ $index }}][size_id]" class="form-control form-control-sm merch-select2">
            <option value="">—</option>
    ...
    <td><input type="text" name="items[{{ $index }}][part_name]" class="form-control form-control-sm" value="{{ $line['part_name'] ?? '' }}"></td>
    <td><input type="number" step="0.0001" min="0" name="items[{{ $index }}][consumption]" class="form-control form-control-sm" value="{{ $line['consumption'] ?? '' }}" required></td>
    <td>
    ...
    <td><input type="number" step="0.01" min="0" max="100" name="items[{{ $index }}][wastage_percent]" class="form-control form-control-sm" value="{{ $line['wastage_percent'] ?? 0 }}"></td>
    <td><input type="number" step="0.0001" min="0" name="items[{{ $index }}][rate]" class="form-control form-control-sm" value="{{ $line['rate'] ?? '' }}"></td>
    <td>
        <select name="items[{{ $index }}][supplier_id]" class="form-control form-control-sm merch-select2">
            <option value="">—</option>
